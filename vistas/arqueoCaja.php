    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div> ARQUEO DE CAJA
                    <div class="page-title-subheading">Control de Arqueo de Caja
                    </div>
                </div>
    ...
    <div id="lista" name="lista">
        <div class="col-lg-12">
            <div class="main-card mb-12 card">
                <div class="card-body">
                    <h5 class="card-title">Listado de arqueo</h5>
...
<script type="text/javascript" src="scripts/arqueoCaja.js"></script>
