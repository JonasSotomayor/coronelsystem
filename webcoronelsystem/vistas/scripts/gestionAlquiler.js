window.onload =()=>
{
   ...
   fechaInicio.addEventListener('change', (e)=>{
    ...
    const btnVerCI=document.getElementById("btnVerCI")
    btnVerCI.onclick=()=>{
        window.open("../files/ciArrendadores/"+imagenCedula , '_blank')
        //document.location("view/files/mesaEntrada/"+hrefImagenes)
    }
