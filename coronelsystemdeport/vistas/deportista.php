    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>GESTIÓN DEPORTISTA PARA  <?php echo strtoupper($_SESSION['deporte']) ?>
                    <div class="page-title-subheading">Gestione los deportistas de  <?php echo ($_SESSION['deporte']) ?>
                    </div>
                </div>
    ...
    <div id="lista" name="lista">
        <div class="col-lg-12">
            <div class="main-card mb-12 card">
                <div class="card-body">
                    <h5 class="card-title">Listado de DEPORTISTA DE  <?php echo strtoupper($_SESSION['deporte']) ?></h5>
                    <div class="table-responsive">
                      <table class="table table-striped" whith="100%" id="tblListadoEmpleados">
                          <thead>
                              <tr>
                                  <th width="10%">Opciones</th>
                                  <th width="30%">DEPORTISTA</th>
                                  <th width="10%">CI</th>
                                ...
                                <div class="form-row" align="center">
                                    <div class="col-md-6">
                                      <div class="position-relative form-group">
                                        ...
                                        <input name="iddetalledeportista" id="iddetalledeportista" placeholder="" type="hidden" class="form-control" required>
                                    ...
                                    <div class="col-md-6">
                                      <div class="position-relative form-group">
                                        <label for="nombreUsuario" class=""><b>SELECIONAR CATEGORIA:</b></label>
                                          <button class="mb-3 mr-3 btn btn-outline-primary btn-lg btn-block"
                                                      type="button" id="BtnAddRazon" data-toggle="modal"
      ...
      <div class="modal-body">
        <div class="form-row" align="center">
            <div class="col-md-12">
              ...
              <h5 class="card-title" align="center">DETALLE CATEGORIA <i  class="fas fa-parking-circle-slash"></i></h5>
              <div class="form-row" align="center">
                <div class="position-relative form-group">
                    <div class="form-row">
                            <label for="tiposocio" class=""><b>CATEGORIA:</b></label>
