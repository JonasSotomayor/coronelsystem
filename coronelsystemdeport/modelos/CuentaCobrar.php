  ...
  public function mostrar($codigo_Cuentas_Cobrar)
	...
	public function listar(){ 
      $sql="SELECT
          ...
          cuentas_cobrar.tipocuenta, 
          razonsocial.idrazonsocial, razonsocial.razonsocial, razonsocial.ci,
          cuentas_cobrar.numerocuota,
          cuentas_cobrar.totalcuota,
          cuentas_cobrar.montoCobrar,
          cuentas_cobrar.fechaCobro,
          cuentas_cobrar.estado,
          codigoFacturas
      FROM cuentas_cobrar, razonsocial, detallecobro
      WHERE cuentas_cobrar.`idrazonsocial`=razonsocial.`idrazonsocial`
      and cuentas_cobrar.tipocuenta='DEPORTISTA'
      and detallecobro.id_cuenta_cobrar=cuentas_cobrar.id_cuenta_cobrar
      and contrato='".$_SESSION['iddeporte']."'
