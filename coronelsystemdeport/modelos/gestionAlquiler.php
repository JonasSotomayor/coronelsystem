...
Class Alquiler
{
	...
	public function editar($alquilerGestion)
	{
		...
		`tipopago` = '$alquilerGestion->tipopago',
		`costoAlquiler` = '$alquilerGestion->costoAlquiler',
		`fechainicio` = '$alquilerGestion->fechainicio',
		`plazoContrato` = '$alquilerGestion->plazoContrato',
		`tiempoContrato` = '$alquilerGestion->tiempoContrato'
